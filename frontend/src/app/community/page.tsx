  ...
  return (
    <AppLayout>
      <div className="p-6">
        ...
        {/* Coming Soon Card */}
        <div className="bg-[#14161d] rounded border border-[#2d3139] p-8 text-center max-w-lg mx-auto mt-12">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#22262f] flex items-center justify-center">
            <Users className="h-8 w-8 text-[#00a449]" />
          </div>
          <h2 className="text-xl font-bold text-white mb-2">Coming Soon</h2>
          <p className="text-[14px] text-[#707990] mb-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-[#22262f] rounded text-left">
              <Lock className="h-5 w-5 text-[#707990]" />
              <div>
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 mt-6 text-[14px] text-[#00a449] hover:text-[#00a449]/80 transition-colors"
          >
            Return to Dashboard
