      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-lg bg-[#26a69a]/20 flex items-center justify-center">
              <Shield className="h-6 w-6 text-[#26a69a]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 text-[12px] text-[#787b86]">
            <kbd className="px-2 py-1 bg-[#2a2e39] rounded">F2</kbd>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#131722] rounded border border-[#2a2e39]">
              <div className="flex items-center gap-2 px-5 py-4 border-b border-[#2a2e39]">
                <Settings className="h-5 w-5 text-[#787b86]" />
              ...
              <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Account Balance */}
                <div>
                  <label className="flex items-center gap-2 text-[13px] text-[#787b86] mb-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-10 pl-8 pr-4 bg-[#1e222d] border border-[#2a2e39] rounded text-white text-[14px] font-mono focus:outline-none focus:border-[#26a69a]/50 transition-colors"
                    />
                  </div>
                </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="relative w-24">
                      <input
                        ...
                        className="w-full h-10 pl-3 pr-8 bg-[#1e222d] border border-[#2a2e39] rounded text-white text-[14px] font-mono focus:outline-none focus:border-[#26a69a]/50 transition-colors"
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#787b86]">%</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="flex-1 flex items-center px-3 bg-[#1e222d] border border-[#2a2e39] rounded text-[14px] text-[#787b86]">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 px-4 bg-[#1e222d] border border-[#2a2e39] rounded text-white text-[14px] font-mono focus:outline-none focus:border-[#26a69a]/50 transition-colors"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#131722] rounded border border-[#2a2e39]">
              <div className="flex items-center gap-2 px-5 py-4 border-b border-[#2a2e39]">
                <Shield className="h-5 w-5 text-[#787b86]" />
              ...
              <div className="p-5 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="text-[13px] text-[#787b86] mb-2 block">
                    Max Shares/Trade
                  </label>
                  <input
                    type="number"
              ...
              {/* Save Button */}
              <div className="px-5 py-4 border-t border-[#2a2e39] flex items-center justify-between">
                <div className="text-[12px] text-[#787b86]">
                  {hasChanges ? (
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#26a69a] hover:bg-[#26a69a]/90 disabled:bg-[#2a2e39] disabled:text-[#787b86] text-white text-[13px] font-medium rounded transition-colors"
                >
            ...
            <div className="bg-[#131722] rounded border border-[#2a2e39]">
              <div className="flex items-center gap-2 px-5 py-4 border-b border-[#2a2e39]">
                <Calculator className="h-5 w-5 text-[#787b86]" />
              ...
              <div className="p-5">
                <div className="grid grid-cols-4 gap-4 mb-4">
                  {/* Ticker */}
                  <div>
                    <label className="text-[12px] text-[#787b86] mb-1.5 block">TICKER</label>
                    <input
                      type="text"
                      value={ticker}
                  ...
                  {/* Entry */}
                  <div>
                    <label className="text-[12px] text-[#787b86] mb-1.5 block">ENTRY</label>
                    <input
                      type="number"
                      step="0.01"
                      value={entryPrice}
                  ...
                  {/* Stop */}
                  <div>
                    <label className="text-[12px] text-[#787b86] mb-1.5 block">STOP</label>
                    <input
                      type="number"
                      step="0.01"
                      value={stopPrice}
                  ...
                  {/* Side */}
                  <div>
                    <label className="text-[12px] text-[#787b86] mb-1.5 block">SIDE</label>
                ...
                {/* Result */}
                {lastResult && (
                  <div className="bg-[#1e222d] rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[#787b86]">SHARES</span>
                      </div>
                      <button
                        onClick={handleCopy}
                        className={`flex items-center gap-2 px-3 py-1.5 rounded text-[12px] font-medium transition-colors ${
                          copied
                            ? "bg-[#26a69a] text-white"
                            : "bg-[#2a2e39] text-white hover:bg-[#3d4149]"
                        }`}
                      >
                    ...
                    <div className="grid grid-cols-4 gap-4 text-[13px]">
                      <div>
                        <span className="text-[#787b86]">Exposición</span>
                        <p className="font-semibold text-white">{formatCurrency(lastResult.position_value)}</p>
                      </div>
                      <div>
                        <span className="text-[#787b86]">Riesgo</span>
                        <p className="font-semibold text-white">
                          {formatCurrency(lastResult.risk_amount)} ({lastResult.risk_percent}%)
                        </p>
                      </div>
                      <div>
                        <span className="text-[#787b86]">Risk/Share</span>
                        <p className="font-semibold text-white">${lastResult.risk_per_share.toFixed(4)}</p>
                      </div>
                      <div>
                        <span className="text-[#787b86]">Target 2:1</span>
                        <p className="font-semibold text-[#26a69a]">{formatCurrency(lastResult.risk_amount * 2)}</p>
                      </div>
                    </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-[#26a69a] hover:bg-[#26a69a]/90 disabled:bg-[#2a2e39] disabled:text-[#787b86] text-white font-medium rounded transition-colors"
                >
          ...
          <div className="space-y-6">
            <div className="bg-[#131722] rounded border border-[#2a2e39]">
              <div className="flex items-center gap-2 px-5 py-4 border-b border-[#2a2e39]">
                <History className="h-5 w-5 text-[#787b86]" />
                <h2 className="text-lg font-semibold text-white">Historial</h2>
              </div>

              <div className="p-4">
                {history.length === 0 ? (
                  <p className="text-center text-[#787b86] text-[13px] py-8">
                  ...
                  <div className="space-y-2">
                    {history.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center justify-between py-2.5 px-3 bg-[#1e222d] rounded"
                      >
                        <div className="flex items-center gap-3">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[11px] text-[#787b86] ml-1">sh</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {/* Quick Info */}
            <div className="bg-[#131722] rounded border border-[#2a2e39] p-5">
              <h3 className="text-[14px] font-semibold text-white mb-3">Fórmula</h3>
              <div className="bg-[#1e222d] rounded p-3 font-mono text-[12px] text-[#a0a8b8]">
                <p>Shares = Risk$ / |Entry - Stop|</p>
                <p className="mt-2 text-[#787b86]">
                  Risk$ = Balance × Risk%
                </p>
              </div>
              ...
              <div className="space-y-2 text-[12px]">
                <div className="flex items-center justify-between">
                  <span className="text-[#787b86]">Calculadora rápida</span>
                  <kbd className="px-2 py-0.5 bg-[#2a2e39] rounded text-white">F2</kbd>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#787b86]">Cerrar modal</span>
                  <kbd className="px-2 py-0.5 bg-[#2a2e39] rounded text-white">ESC</kbd>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#787b86]">Calcular</span>
                  <kbd className="px-2 py-0.5 bg-[#2a2e39] rounded text-white">Enter</kbd>
                </div>
              </div>
            </div>
          </div>
